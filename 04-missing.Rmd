...
data <- readRDS(file = "code/kills.Rda")
...
Less than 30 percent of the kills have one of the previous points i.e. for more than 70 percent of the kills, flash, assist and revenge do not happen.
...
```{r , fig.width=14, fig.height=8}
data <- readRDS(file = "code/damages.Rda")
plot_missing(data, Percentflag  = TRUE)
```
