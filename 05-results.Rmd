...
```
Nuke as been removed from the official maps after Katowice 2015 and reintroduced for Cologne 2016.[5](https://www.hltv.org/news/17622/new-update-adds-nuke-to-active-duty) It was known to greatly favor the CT side, often forcing the team starting on the T side to have an impressive comeback after switching sides on the half time.
...
For example, in 2017 developers tried to increase the usage of smg type weapons by increasing their damage output, especially for the ump. As a result, the ump was often used by teams when they could not get a rifle. But complains from pro players meant that the update was reverted. [6](https://www.hltv.org/news/20546/new-update-changes-the-ump45)
