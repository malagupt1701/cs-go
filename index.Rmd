...
These two teams play as both the Terrorist (T) and Counter- Terrorist (CT) sides over the course of a professional match. On each map, teams are
initially assigned T or CT and then play for 15 rounds as their assigned side. Teams switch sides after the 15th round. The first team to win 16 rounds in either wins the match. 
...
The overall aim of the game being to assassinate the other team whilst successfully completing side objectives.
...
##  How can the data bring answers to the questions?
- Game analysts and players traditionally only watch the demo replays to study teams and player behaviors. Data can help automate this process by showing some players’ habits. For instance,  we could look at the buying habits of a team, their preferential positions on maps, grenade throws, etc.
- Data can help understand the performance of players and teams by calculating some metrics such as accuracy, teamplay flashes, trades, assists, etc. Those metrics can be combined to create a global rating.
